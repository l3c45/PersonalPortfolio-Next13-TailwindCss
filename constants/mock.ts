...
export const proyects =[
  ...
  },
  {
    ...
    subtitle:"Pagina construida con JS y Css responsivo , forma parte de un Challengue del bootcamp ONE – Oracle Next Education",
  ...
  //   subtitle:"API que devuelve la fecha introducida al formato UTC y viceversa",
